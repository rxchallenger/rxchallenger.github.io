!(function (t, e) {
    ...
    S = (function () {
      ...
      return (
        ...
        (t._jQueryInterface = function (n) {
          return this.each(function () {
            var i = e(this).data(_);
            i || ((i = new t(this)), e(this).data(_, i)),
              "toggle" === n && i[n]();
          });
        }),
        o(t, null, [
          ...
          if (
            !(
              ...
              (this._parent &&
                ...
                (n = null),
              n && (i = e(n).not(this._selector).data(U)) && i._isTransitioning)
            )
          ) {
            ...
            if ((e(this._element).trigger(r), !r.isDefaultPrevented())) {
              ...
              e(this._element)
                .one(a.TRANSITION_END, function () {
                  e(o._element).removeClass(Y).addClass(V).addClass(B),
                    (o._element.style[s] = ""),
          ...
          if (!this._isTransitioning && e(this._element).hasClass(B)) {
            ...
            if ((e(this._element).trigger(n), !n.isDefaultPrevented())) {
              ...
              (this._element.style[i] =
                ...
                e(this._element).addClass(Y).removeClass(V).removeClass(B);
                ...
                for (var r = 0; r < o; r++) {
                  ...
                  null !== l &&
                    (e([].slice.call(document.querySelectorAll(l))).hasClass(
                      ...
                      e(s).addClass(z).attr("aria-expanded", !1));
                }
              ...
              e(this._element)
                .one(a.TRANSITION_END, function () {
                  t.setTransitioning(!1),
                    e(t._element).removeClass(Y).addClass(V).trigger(Q.HIDDEN);
                })
                .emulateTransitionEnd(c);
            }
          }
  ...
  e(document).on(Q.CLICK_DATA_API, $, function (t) {
    ...
    (e.fn[F] = G._jQueryInterface),
    (e.fn[F].Constructor = G),
          ...
          if (!this._element.disabled && !e(this._element).hasClass(rt)) {
            ...
            if ((t._clearMenus(), !o)) {
              ...
              if ((e(i).trigger(s), !s.isDefaultPrevented())) {
                ...
                "ontouchstart" in document.documentElement &&
                  0 === e(i).closest(".navbar-nav").length &&
  ...
  e(document).on(Et.CLICK_DATA_API, '[data-toggle="modal"]', function (t) {
    ...
    (e.fn[dt] = It._jQueryInterface),
    (e.fn[dt].Constructor = It),
          ...
          a.forEach(function (t) {
            (function (t, e) {
              ...
              if (-1 !== e.indexOf(n))
                return (
                  -1 === Dt.indexOf(n) ||
                  Boolean(t.nodeValue.match(wt) || t.nodeValue.match(At))
                );
              for (
      ...
      return (
          ...
          "object" != typeof n || (!n.nodeType && !n.jquery)
            ? this.config.html
              ? (this.config.sanitize &&
                  (n = Nt(n, this.config.whiteList, this.config.sanitizeFn)),
                t.html(n))
              : t.text(n)
            : this.config.html
        ...
        (i._enter = function (t, n) {
          ...
          (n = n || e(t.currentTarget).data(i)) ||
            ...
            e(n.getTipElement()).hasClass(Qt) || n._hoverState === Wt
              ? (n._hoverState = Wt)
        ...
        (t._jQueryInterface = function (n) {
          return this.each(function () {
            ...
            if (
              ...
              (i || ((i = new t(this, o)), e(this).data(kt, i)),
              "string" == typeof n)
            ) {
              if (void 0 === i[n])
                throw new TypeError('No method named "' + n + '"');
  ...
  (e.fn[Ot] = Yt._jQueryInterface),
    (e.fn[Ot].Constructor = Yt),
        ...
        (r._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            if (
              ...
              (n || ((n = new r(this, i)), e(this).data(Xt, n)),
              "string" == typeof t)
            ) {
              if (void 0 === n[t])
    ...
    me = (function () {
      ...
      return (
        ...
        (n._getConfig = function (t) {
          if (
            "string" !=
            typeof (t = r({}, le, "object" == typeof t && t ? t : {})).target
          ) {
            var n = e(t.target).attr("id");
            n || ((n = a.getUID(oe)), e(t.target).attr("id", n)),
              (t.target = "#" + n);
          }
        ...
        (n._activate = function (t) {
          ...
          i.hasClass("dropdown-item")
            ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(ue),
              i.addClass(ue))
            : (i.addClass(ue),
              i
                .parents(fe)
      ...
      return (
        (n.show = function () {
          ...
          if (
            ...
            var l = e.Event(ye.HIDE, { relatedTarget: this._element }),
              c = e.Event(ye.SHOW, { relatedTarget: i });
            if (
              (i && e(i).trigger(l),
              ...
              var h = function () {
                var n = e.Event(ye.HIDDEN, { relatedTarget: t._element }),
                  o = e.Event(ye.SHOWN, { relatedTarget: i });
        ...
        (n._transitionComplete = function (t, n, i) {
          ...
          if (
            ...
            a.reflow(t),
            t.classList.contains(Te) && t.classList.add(Se),
        ...
        (t._jQueryInterface = function (n) {
          return this.each(function () {
            var i = e(this),
              o = i.data(pe);
            if (
              (o || ((o = new t(this)), i.data(pe, o)), "string" == typeof n)
            ) {
              if (void 0 === o[n])
                throw new TypeError('No method named "' + n + '"');
              o[n]();
  ...
  e(document).on(
    ...
    (e.fn.tab = De._jQueryInterface),
    (e.fn.tab.Constructor = De),
      ...
      return (
        ...
        (n.hide = function (t) {
          ...
          this._element.classList.contains(Le) &&
            (e(this._element).trigger(ke.HIDE),
            t
              ? this._close()
        ...
        (n.dispose = function () {
          clearTimeout(this._timeout),
            ...
            e(this._element).off(ke.CLICK_DISMISS),
        ...
        (t._jQueryInterface = function (n) {
          return this.each(function () {
            ...
            if (
              (o ||
                ((o = new t(this, "object" == typeof n && n)), i.data(Ae, o)),
              "string" == typeof n)
            ) {
              if (void 0 === o[n])
                throw new TypeError('No method named "' + n + '"');
  ...
  (e.fn[we] = xe._jQueryInterface),
    (e.fn[we].Constructor = xe),
