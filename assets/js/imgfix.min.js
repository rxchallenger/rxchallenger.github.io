...
!(function (a) {
  function t(t) {
    var e = a(a(t).parents(".imgfix_wrapper_layer")[0]),
      i = a(e.parents(".imgfix_top_container")[0]),
      s = a(t).width(),
      r = a(t).height(),
      f = e.width(),
      l = e.height(),
    ...
    i.data("fix-fixin")
      ...
      : l > o && ((n = s * (d = l / r)), (o = r * d));
    var u = e[0].id;
    a("#imgfix_img_style_for_" + u).remove();
    var x = "";
    (null != i.data("fix-defaults-grayscale") ||
      null != i.data("fix-defaults-sepia") ||
      null != i.data("fix-defaults-hue") ||
      null != i.data("fix-defaults-saturate") ||
      null != i.data("fix-defaults-invert") ||
      null != i.data("fix-defaults-brightness") ||
      null != i.data("fix-defaults-contrast") ||
      null != i.data("fix-defaults-blur")) &&
      ((x =
        null != i.data("fix-defaults-grayscale")
          ? "grayscale(" + parseInt(i.data("fix-defaults-grayscale")) + "%) "
          : ""),
      (x +=
        null != i.data("fix-defaults-sepia")
          ? "sepia(" + parseInt(i.data("fix-defaults-sepia")) + "%) "
          : ""),
      (x +=
        null != i.data("fix-defaults-hue")
          ? "hue-rotate(" + parseInt(i.data("fix-defaults-hue")) + "deg) "
          : ""),
      (x +=
        null != i.data("fix-defaults-saturate")
          ? "saturate(" + parseInt(i.data("fix-defaults-saturate")) + "deg) "
          : ""),
      (x +=
        null != i.data("fix-defaults-invert")
          ? "invert(" + parseInt(i.data("fix-defaults-invert")) + "%) "
          : ""),
      (x +=
        null != i.data("fix-defaults-brightness")
          ? "brightness(" + parseInt(i.data("fix-defaults-brightness")) + "%) "
          : ""),
      (x +=
        null != i.data("fix-defaults-contrast")
          ? "contrast(" + parseInt(i.data("fix-defaults-contrast")) + "%) "
          : ""),
      (x +=
        null != i.data("fix-defaults-blur")
          ? "blur(" + parseInt(i.data("fix-defaults-blur")) + "px) "
          : "")),
      x && (x = "filter: " + x + "; -webkit-filter: " + x + ";");
    var c = "";
    (null != i.data("fix-grayscale") ||
      null != i.data("fix-sepia") ||
      null != i.data("fix-hue") ||
      null != i.data("fix-saturate") ||
      null != i.data("fix-invert") ||
      null != i.data("fix-brightness") ||
      null != i.data("fix-contrast") ||
      null != i.data("fix-blur")) &&
      ((c =
        null != i.data("fix-grayscale")
          ? "grayscale(" + parseInt(i.data("fix-grayscale")) + "%) "
          : null != i.data("fix-defaults-grayscale")
          ? "grayscale(" + parseInt(i.data("fix-defaults-grayscale")) + "%) "
          : ""),
      (c +=
        null != i.data("fix-sepia")
          ? "sepia(" + parseInt(i.data("fix-sepia")) + "%) "
          : null != i.data("fix-defaults-sepia")
          ? "sepia(" + parseInt(i.data("fix-defaults-sepia")) + "%) "
          : ""),
      (c +=
        null != i.data("fix-hue")
          ? "hue-rotate(" + parseInt(i.data("fix-hue")) + "deg) "
          : null != i.data("fix-defaults-hue")
          ? "hue-rotate(" + parseInt(i.data("fix-defaults-hue")) + "deg) "
          : ""),
      (c +=
        null != i.data("fix-saturate")
          ? "saturate(" + parseInt(i.data("fix-saturate")) + "%) "
          : null != i.data("fix-defaults-saturate")
          ? "saturate(" + parseInt(i.data("fix-defaults-saturate")) + "%) "
          : ""),
      (c +=
        null != i.data("fix-invert")
          ? "invert(" + parseInt(i.data("fix-invert")) + "%) "
          : null != i.data("fix-defaults-invert")
          ? "invert(" + parseInt(i.data("fix-defaults-invert")) + "%) "
          : ""),
      (c +=
        null != i.data("fix-brightness")
          ? "brightness(" + parseInt(i.data("fix-brightness")) + "%) "
          : null != i.data("fix-defaults-brightness")
          ? "brightness(" + parseInt(i.data("fix-defaults-brightness")) + "%) "
          : ""),
      (c +=
        null != i.data("fix-contrast")
          ? "contrast(" + parseInt(i.data("fix-contrast")) + "%) "
          : null != i.data("fix-defaults-contrast")
          ? "contrast(" + parseInt(i.data("fix-defaults-contrast")) + "%) "
          : ""),
      (c +=
        null != i.data("fix-blur")
          ? "blur(" + parseInt(i.data("fix-blur")) + "px) "
          : null != i.data("fix-defaults-blur")
          ? "blur(" + parseInt(i.data("fix-defaults-blur")) + "px) "
          : "")),
      c &&
      ...
      a("head").append(
        '<style id="imgfix_img_style_for_' +
          ...
          parseInt(i.data("fix-interval")) / 1e3 +
          "s " +
          i.data("fix-easing") +
          " ;transition: all " +
          parseInt(i.data("fix-interval")) / 1e3 +
  ...
  function e(t, e) {
    ...
    var s = a(t).parents(".imgfix_top_container")[0];
    a(s).off();
    var r = t.data("slide");
    switch ((i(t), r)) {
      case "in-up":
        ...
        t.addClass("imgfix-in-up"),
          a(s).on("mouseenter", t, function (t) {
            ...
            for (var r = 0; r < s.length; r++) {
              ...
              if (l != this) {
                var d = "";
                a(l).offset().top > a(this).offset().top
                  ? (d = "down")
                  : a(l).offset().top < a(this).offset().top
                  ? (d = "up")
                  : a(l).offset().left < a(this).offset().left
                  ? (d = "right")
                  : a(l).offset().left > a(this).offset().left && (d = "left"),
                  a(l).offset().top < a(this).offset().top &&
                  a(l).offset().left < a(this).offset().left
                    ? (d = "down-right")
                    : a(l).offset().top > a(this).offset().top &&
                  ...
                  i(a(l).find(".imgfix_cover_wrapper"), "imgfix-in-" + d);
              }
            }
          }),
          a(s).on("mouseleave", t, function (t) {
            var e = t.data.parents(".imgfix_wrapper_layer")[0].id.split("_")[3];
            if (!a(f.family[e].element).find(":hover").length) {
              var s,
                r =
                  null == t.offsetX
              ...
              (s =
                l < 0.1 * t.data.height()
                  ...
                  ? "left"
                  : "right"),
                t.data.addClass("imgfix-in-" + s),
                i(t.data, "imgfix-in-" + s);
            }
          });
        break;
      default:
  ...
  var f = {
    family: new Array(),
    init: function (i, f) {
      var l = i.parameters ? i.parameters : new Object(),
        d = i.element;
      l.cover || (l.cover = {}),
      ...
      for (var n = 0; n < d.length; n++) {
        ...
        var u = o.find("#imgfix_wrapper_layer_" + i.id + "_" + n).length
          ? 0
          : 1;
        if (f)
          ...
          if (
            ...
            (x = o.data("fix-height")).split("%").length > 1 &&
              (x = (x = parseFloat(x.split("%")[0]))
                ? (o.width() * x) / 100
                : 0),
              o.height(x);
        ...
        if (
          ...
          t(
            a("#imgfix_wrapper_layer_" + i.id + "_" + n + " .imgfix_src_img")[0]
          ),
          u &&
            a(
              "#imgfix_wrapper_layer_" + i.id + "_" + n + " .imgfix_src_img"
            ).load(function () {
              t(this);
            }),
          o.data("fix-cover"))
  ...
  (a.fn.imgfix = function (t) {
    for (var e = -1, i = !1, s = 0; s < f.family.length; s++) {
      var r = !0;
      for (var l in this) this[l] != f.family[s].element[l] && (r = !1);
      if (r) {
        (e = s), (i = !0);
        break;
      }
    }
    0 > e && (f.family.push(new Object()), (e = f.family.length - 1)),
      (f.family[e] = { id: e, element: this, parameters: t }),
      f.init(f.family[e], i),
    ...
    (a.fn.imgfixRefresh = function () {
      for (
        ...
        e[t[i].id.split("_")[3]] = !0;
      }
      for (var s in e) f.init(f.family[s]);
    });
})(jQuery);
