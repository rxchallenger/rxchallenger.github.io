!(function (e, t) {
      ...
      function (e, t) {
        h.fn[e] = function (n, r) {
          ...
          return (
            ...
            this.length > 1 && (j[e] || h.unique(i), D.test(e) && i.reverse()),
            this.pushStack(i)
          );
        };
      }
    ...
    h.fn.extend({
      ...
      domManip: function (e, t) {
        ...
        var n,
          ...
          g = e[0],
          m = h.isFunction(g);
        if (m || (c > 1 && "string" == typeof g && !f.checkClone && re.test(g)))
      ...
      "margin" === n && (s += h.css(e, n + I[o], !0, i)),
        r
          ? ("content" === n && (s -= h.css(e, "padding" + I[o], !0, i)),
            "margin" !== n && (s -= h.css(e, "border" + I[o] + "Width", !0, i)))
        ...
        if (e && 3 !== o && 8 !== o && 2 !== o)
          return typeof e.getAttribute === z
            ...
            : ((1 === o && h.isXMLDoc(e)) ||
                ...
                (r =
                  h.attrHooks[t] ||
                  (h.expr.match.bool.test(t) ? Ve : undefined))),
              void 0 === n
  ...
  return (
    (h.noConflict = function (t) {
      return e.$ === h && (e.$ = At), t && e.jQuery === h && (e.jQuery = St), h;
    }),
